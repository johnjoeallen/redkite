...
| `ProjectConfigFile` | Reads a project's own `.redkite/settings.yml` (or `settings.yaml`) — extra Maven arguments, profile, Spring profile, environment variables — see [Build Validation](../projects/build-validation.md) |
